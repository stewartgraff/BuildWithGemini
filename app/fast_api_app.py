...
app.title = "buildwithgemini"
app.description = "API for interacting with the Agent buildwithgemini"
...
# Attach frontend planner REST API endpoints and static SPA
...
if os.path.exists(static_dir):
    ...
    async def get_planner_page() -> FileResponse:
        return FileResponse(os.path.join(static_dir, "index.html"))

    @app.get("/", include_in_schema=False)
    async def get_root_page() -> FileResponse:
        return FileResponse(os.path.join(static_dir, "index.html"))
